...
import ToeslagtabellenPage from './pages/ToeslagtabellenPage';
      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path="/toeslagtabellen" element={<ProtectedRoute><AppLayout><ToeslagtabellenPage /></AppLayout></ProtectedRoute>} />
          </Routes>
        </Router>
      </AuthProvider>
    </ChakraProvider>
